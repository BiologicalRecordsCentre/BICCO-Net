...
# for site with multiple SINDEX values in the same year, take the rounded mean value.



### Loop through each species and only include sites with at least 7 years of data for ### ~~~~ DISCUSS WITH NICK ET AL. is what are the best exclusion criteria ~~~~
